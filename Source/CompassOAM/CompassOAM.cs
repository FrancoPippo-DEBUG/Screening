...
namespace CompassOAM
{
    internal class CompassOAM
    {
        ...
        static void Main()
        {
            ...
            var log = new LogFile();
            //var repo = new LogFile("REPORT_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".log");
            var excel = new Excel();
            ...
            try
            {
                ...
                /*
                string lavorazione = input.result["lavorazione"];
                if (lavorazione == "106&107")
                {
                    foglio_excel = 3;
                }
                else if (lavorazione == "MEDIATORI")
                {
                    foglio_excel = 2;
                }
                else if (lavorazione == "PROMOTORI")
                {
                    foglio_excel = 1;
                }
                */
