                ...
                while (true)
                {
                                ...
                                if (soggetti.Count > 0)
                                {
                                    for (int i = 0; i < 14; i++)
                                    {
                                        if (i <= soggetti.Count - 1)
                                        {
                                            ...
                                            string nato_il = DateTime.Parse(soggetti[i][1], new CultureInfo("it-IT")).ToString("dd/MM/yyyy");
                        ...
                        else
                        {
                            ...
                            { // PROVO A CERCARE LA SOCIETA' PARTENDO DAI SOGGETTI
                                foreach (List<string> x in soggetti)
                                {
                                    ...
                                    string nato_il = DateTime.Parse(x[1], new CultureInfo("it-IT")).ToString("dd/MM/yyyy");
                                    string nato_a = x[2];
                    ...
                    else if (tipo_intermediario == "PV") // ================================================== TIPO INTERMEDIARIO: PV
                    {
                        if (soggetti.Count > 0)
                        {
                            ...
                            string nato_il = DateTime.Parse(soggetti[0][1], new CultureInfo("it-IT")).ToString("dd/MM/yyyy");
